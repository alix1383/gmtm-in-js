...
/* harmony import */ var _modules_steamApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/steamApi */ "./src/modules/steamApi.js");
...
/* harmony export */   SteamApi: () => (/* binding */ SteamApi)
/* harmony export */ });
...
class SteamApi {
  constructor(apiKey) {
    this.axios = axios__WEBPACK_IMPORTED_MODULE_1__["default"].create({
      baseURL: "https://ali-x.ir//proxy.php?csurl=https://api.steampowered.com/IGameServersService/",
      // params: {
      //     key: apiKey,
      // },
      timeout: 5000,
  ...
  async checkToken() {
    try {
      ...
      if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isObject)(data) && data.is_banned === false) {
        return true;
      } else {
        return false;
      }
  ...
  async generateNewToken(memo, appId) {
    await this.axios.post(`CreateAccount/v1/`, {
      key: this.apiKey,
      appid: appId,
      memo: memo
    }).then(r => {
